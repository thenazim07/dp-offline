...
const setEditInfo = (item: Object) => {
    ...
    initialValues.doctor_ref = item?.doctor_ref;
    initialValues.item_name = item?.name;
    initialValues.item_code = item?.code;
    initialValues.item_identical_name = item?.item_identical_name;
    initialValues.weight = item?.weight;
    initialValues.description = item.description;
    initialValues.item_ref = item.ref;
};
                                                ...
                                                >
                                                    <div class="mb-4">
                                                        ...
                                                        <VField
                                                            ...
                                                            type="text"
                                                            disabled
                                                            class="font-poppins-regular block w-full rounded-sm border border-slate-300 bg-slate-50 py-2.5 pl-4 pr-3 leading-5 text-slate-500 placeholder-slate-500 focus:border-blue-500 focus:bg-white focus:text-gray-900 focus:placeholder-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
