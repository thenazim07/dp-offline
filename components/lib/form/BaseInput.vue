...
<template>
    <div class="relative">
        <input
            ...
            class="font-poppins-regular peer block w-full appearance-none rounded-md border bg-transparent px-2.5 pb-2.5 pt-2 text-base text-gray-900 focus:outline-none focus:ring-0"
            placeholder=" "
            :name="name"
            :type="type"
            @input="handleChange"
