<template>
    <div>
        <div class="z-50 h-[172px] min-w-[790px] rounded-lg border border-[#136AFB] bg-white shadow-lg">
            <UTabs
                :items="items"
                ...
                <template #item="{ item }">
                    ...
                    >
                        <!-- <div class="flex items-center gap-6">
                            <div class="w-1/4 text-[15px] font-bold leading-[22px] text-[#1E293B]">
                                <img
                            ...
                            <div class="flex flex-grow gap-2">
                                <input
                                    ...
                                    type="checkbox"
                                    value="auto"
                                    :checked="formData.label?.printable"
                                    v-model="formData.label.printable"
                                />
                                <label
                                    for="printableStyle"
                    ...
                    >
                        <div class="flex items-center gap-6">
                            <div class="w-1/4 text-[15px] font-bold leading-[22px] text-[#1E293B]">Uploaded Image</div>
                            <div class="flex flex-grow">
                                <div
                                    class="flex h-[43px] w-[93px] items-center justify-center gap-[2px] rounded-l-md border border-[#E2E8F0]"
                                >
